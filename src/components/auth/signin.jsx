  ...
  return (
    <>
      <section className="bg-white ">
        <div
          className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 bg-gradient-to-tr from-[#470552] via-[#0d021f] via-[#20072f] via-[#3a0842] to-[#000000]
"
        >
          <a
            href="#"
          ...
          <div className="w-full bg-gray-200/60 rounded-lg md:mt-0 sm:max-w-md xl:p-0 border-1 border-[#f8f4ff] shadow-[0_0_10px_#f8f4ff] ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl font-bold leading-tight tracking-tight md:text-2xl text-white/80">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="remember" className="text-gray-50/70">
                        Remember me
                      </label>
                    </div>
                  </div>
